...
class CustomTextEditState extends State<CustomTextEdit> with TextInputClient {
  ...
  void reassemble() {
    super.reassemble();
    // Reattach after hot reload so an existing connection also receives the
    // current view configuration, without interrupting the SSH session.
    _closeInputConnectionIfNeeded();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted && widget.focusNode.hasFocus) _openInputConnection();
    });
  }
